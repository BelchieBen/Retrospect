...
CREATE TABLE "CardMembers" (
    ...
    CONSTRAINT "CardMembers_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Comment_value_idx" ON "Comment"("value");

-- CreateIndex
CREATE INDEX "BoardMembers_boardId_userId_idx" ON "BoardMembers"("boardId", "userId");

-- CreateIndex
CREATE INDEX "CardMembers_cardId_userId_idx" ON "CardMembers"("cardId", "userId");
...
-- AddForeignKey
ALTER TABLE "Boards" ADD CONSTRAINT "Boards_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BoardMembers" ADD CONSTRAINT "BoardMembers_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Boards"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CardMembers" ADD CONSTRAINT "CardMembers_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CardMembers" ADD CONSTRAINT "CardMembers_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
